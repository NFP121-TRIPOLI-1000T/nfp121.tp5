...
public class IHMListeTest2 extends junit.framework.TestCase{
    ...
    public void test_IHMListe2_rechercher() {
        try{
    ...
    public void test_IHM2_occurrence() {
        try{
            Container panel = f.getContentPane();
            Component[] components = panel.getComponents();
    ...
    public void test_IHMListe2_retirer() {
        try{
            Container panel = f.getContentPane();
            Component[] components = panel.getComponents();
            assertEquals(components.length, 1);
    ...
    public void test_IHMListe2_retirer_et_occurrence() {
        try{
            Container panel = f.getContentPane();
            Component[] components = panel.getComponents();
            assertEquals(components.length, 1);
